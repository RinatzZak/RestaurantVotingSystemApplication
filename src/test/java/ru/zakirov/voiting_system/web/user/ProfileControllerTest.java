package ru.zakirov.voiting_system.web.user;
...
import ru.zakirov.voiting_system.to.UserTo;
import ru.zakirov.voiting_system.util.JsonUtil;
import ru.zakirov.voiting_system.util.UserUtil;
...
import static ru.zakirov.voiting_system.web.user.ProfileController.REST_URL;
import static ru.zakirov.voiting_system.web.user.UserTestData.*;
